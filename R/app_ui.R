...
app_ui <- function(request) {
  tagList(
    ...
    dashboardPage(
      ...
      dashboardSidebar(
        sidebarMenu(
          menuItem("Welcome", tabName = "welcome", icon = icon("home")), # available icons at https://fontawesome.com/icons?d=gallery
      ...
      dashboardBody(
        ...
        tabItems(
          ...
          # UI for page Search and Download
